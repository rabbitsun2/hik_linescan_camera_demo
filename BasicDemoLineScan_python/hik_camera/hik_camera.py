...
class HikCamera(hik.MvCamera):
    ...
    @classmethod
    def get_all_ips(cls) -> List[str]:  # 수정된 부분
        """
    ...
    @classmethod
    def get_cams(cls, ips=None) -> Dict[str, "HikCamera"]:  # 수정된 부분
        """
    ...
    def get_shape(self) -> Tuple[int, int]:  # 수정된 부분
        """
    ...
    @classmethod
    def _get_dev_info(cls, ip: str = None) -> Dict[str, hik.MV_CC_DEVICE_INFO]:  # 수정된 부분
        """
        Class method that returns a list of all connected camera IP addresses
